                ...
                Builder(
                  builder: (context) {
                    int incrementSeconds =
                        isSpecialBot && preferences.clock.increment.inSeconds > 10
                            ? 10
              ...
              if (!isSpecialBot) ...[
                ...
                ExpandedSection(
                  ...
                  child: SmallBoardPreview(
                    orientation:
                        preferences.sideChoice == SideChoice.black ? Side.black : Side.white,
              ...
              if (isSpecialBot) ...[
                LayoutBuilder(
                  builder: (context, constraints) {
                    ...
                    final userBotFens = _botFens[widget.user.name.toLowerCase()] ?? [];
                              ...
                              return GestureDetector(
                                onTap: () {
                                  ...
                                  ref
                                      .read(challengePreferencesProvider.notifier)
                                      .setSideChoice(
                                        side == Side.white ? SideChoice.white : SideChoice.black,
                                      );
                                },
                                child: Container(
